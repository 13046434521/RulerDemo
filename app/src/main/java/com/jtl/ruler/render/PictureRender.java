...
public class PictureRender {
    private static final String TAG = PictureRender.class.getSimpleName();
    private static final String VERTEX_SHADER = "shader/point_vert.glsl";
    private static final String FRAGMENT_SHADER = "shader/point_frag.glsl";
